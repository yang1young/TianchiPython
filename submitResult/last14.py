...
filtered_item_store_feature = filterItem(item_store_feature,days_20151214,days_20151227)
...
def getAllStoreTestResult():
    ...
    for i,j in filtered_item_feature.groupby([filtered_item_feature['item_id']]):
        ...
        pd.DataFrame(items,columns=None).to_csv("/Users/zhuohaizhen/PycharmProjects/Tianchi_Python/"
                                        "Data/TestData/last14_sample_all.csv",index = None,columns=None)
...
def getKidStoreTestResult():
    ...
    for i,j in filtered_item_store_feature.groupby([filtered_item_store_feature['item_id'],
        ...
        #break
        pd.DataFrame(items,columns=None).to_csv("/Users/zhuohaizhen/PycharmProjects/Tianchi_Python/"
                                        "Data/TestData/last14_sample_kid.csv",index = None,columns=None)

def addTwoFile(file1,file2,final_file):
    f1 = open(file1)
    f2 = open(file2)
    ff = open(final_file,"wb+")
    flag = 0
...
addTwoFile(
    "/Users/zhuohaizhen/PycharmProjects/Tianchi_Python/Data/TestData/last14_sample_kid.csv",
    "/Users/zhuohaizhen/PycharmProjects/Tianchi_Python/Data/TestData/last14_sample_all.csv",
    "/Users/zhuohaizhen/PycharmProjects/Tianchi_Python/Data/TestData/last14_sample_final.csv")
